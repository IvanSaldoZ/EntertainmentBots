...
/*
 *
 * Бот для сканирования сайта Geektimes на наличие новых статей
 *
 */
class BotGeektimes extends Bot
{

    const __BOT_NAME = 'Geektimes';
    const __SITE_NAME = 'Geektimes'; //Отобажаемое название сайта
